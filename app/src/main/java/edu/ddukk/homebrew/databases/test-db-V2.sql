...
INSERT INTO room_master_table VALUES(42,'60baefe4bb391a1dca552281d90255bc');
...
INSERT INTO user VALUES(2,'Anu','Varghese','anu@gmail.com','anu');
INSERT INTO user VALUES(3,'Binu','Simon','Binu@gmail.com','binu');
INSERT INTO user VALUES(4,'Anu','Varghese','anu@gmail.com','anu');
CREATE TABLE `timetable` (`table_id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `day_of_week` TEXT NOT NULL, `start_time` TEXT NOT NULL, `end_time` TEXT NOT NULL, `period` TEXT NOT NULL, `programs_id` INTEGER NOT NULL, `semester_id` INTEGER NOT NULL, `subject_id` TEXT NOT NULL, `instructor_id` INTEGER, `break_id` INTEGER, FOREIGN KEY(`subject_id`) REFERENCES `subjects`(`subject_id`) ON UPDATE NO ACTION ON DELETE SET NULL , FOREIGN KEY(`instructor_id`) REFERENCES `instructors`(`instructor_id`) ON UPDATE NO ACTION ON DELETE SET NULL , FOREIGN KEY(`break_id`) REFERENCES `breaks`(`break_id`) ON UPDATE NO ACTION ON DELETE SET NULL , FOREIGN KEY(`programs_id`) REFERENCES `programs`(`programs_id`) ON UPDATE NO ACTION ON DELETE SET NULL , FOREIGN KEY(`semester_id`) REFERENCES `semesters`(`semester_id`) ON UPDATE NO ACTION ON DELETE SET NULL );
CREATE TABLE `subjects` (`subject_id` TEXT NOT NULL, `subject_name` TEXT NOT NULL, PRIMARY KEY(`subject_id`));
INSERT INTO subjects VALUES('23-493-0201','PROJECT MANAGEMENT ');
INSERT INTO subjects VALUES('23-493-0202','Android App Development - Kotlin & XML');
INSERT INTO subjects VALUES('23-493-0203','Android App Development - JetPack Compose');
INSERT INTO subjects VALUES('23-493-0204','CLOUD AND ADVANCED TECHNOLOGIES');
INSERT INTO subjects VALUES('23-493-0205','Elective – I - Flutter for Beginners');
INSERT INTO subjects VALUES('23-493-0206','Elective – II - Communicative English (Inter Dept)');
INSERT INTO subjects VALUES('23-493-0207','SOFTWARE LAB-II (ANDROID & CLOUD)');
INSERT INTO subjects VALUES('23-493-0208','INTERNSHIP I – ANDROID/WEB APP DEVELOPMENT');
